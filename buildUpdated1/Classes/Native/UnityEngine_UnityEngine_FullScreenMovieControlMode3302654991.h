...
struct  FullScreenMovieControlMode_t3302654991 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FullScreenMovieControlMode_t3302654991, ___value___1)); }
