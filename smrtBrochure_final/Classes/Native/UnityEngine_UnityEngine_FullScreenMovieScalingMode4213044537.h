...
struct  FullScreenMovieScalingMode_t4213044537 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(FullScreenMovieScalingMode_t4213044537, ___value___1)); }
